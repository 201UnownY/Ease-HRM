...
public interface IPayrollService
{
    ...
    Task<PayrollDto> ProcessPayrollAsync(ProcessPayrollRequest request, CancellationToken cancellationToken = default);
    Task<PayrollDto> AdjustPayrollAsync(AdjustPayrollRequest request, CancellationToken cancellationToken = default);
