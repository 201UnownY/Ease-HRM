...
public interface IOrgUnitRepository
{
    ...
    Task<bool> NameExistsAsync(string name, Guid excludeOrgUnitId, CancellationToken cancellationToken = default);
    ...
    Task<OrgUnit?> GetByIdAsync(Guid orgUnitId, CancellationToken cancellationToken = default);
